...
*/
    ...
    public static void testSonucu(char[][] answers, char[] keys) {
        ...
        for (int i = 0; i < answers.length ; i++) { // Here bir ogrenciye bakar i=> ogrenci
            int sayac=0; // Her ogrenci donguye girmeden sayacin sifirlanmasi icin sayac'i burda olusturduk.
            for (int j = 0; j <answers[i].length ; j++) { //Her ogrencinin cevabina bakar j=>ogrenci cevaplari

                if (answers[i][j]==keys[j]){ // Cevap Anahtari ile pgrenci cevaplarini karsilastirir
                    sayac++;
