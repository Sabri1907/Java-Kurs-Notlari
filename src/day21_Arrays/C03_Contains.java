...
public class C03_Contains {
    public static void main(String[] args) {
        //Soru 3- Kullanicidan aldiginiz bir ismin verilen bir array'da olup olmadigini
    ...
    public static boolean contains(String[] isimler, String arananIsim) {
        boolean sonucMethod=false; // default bir deger atadik. Scope farkli oldugu icin yeni bir sonuc variable'i
                                   // olusturduk.
